...
const v2ReadRoutes = require('./routes/v2/read');
...
if (supabase) {
  ...
  app.use('/api/v2/projects/:id/read', optionalAuth(supabase), v2ReadRoutes);
  ...
  app.use('/api/v2/projects/:id/read', v2ReadRoutes);

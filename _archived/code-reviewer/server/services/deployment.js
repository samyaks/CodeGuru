...
/**
 * Scan a GitHub file tree for deployment-related files.
 * @param {Array<{path: string, type: string}>} tree - GitHub tree API response items
 * @returns {{ detected: boolean, cicd: Array, hosting: Array, containers: Array, iac: Array, allPaths: string[] }}
 */
...
/**
 * Check a list of changed file paths (from a PR) for deployment-related files.
